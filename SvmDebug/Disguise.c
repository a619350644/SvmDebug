...
#include <windef.h>
#include <intrin.h>
// 在 Disguise.c 的 includes 下面加上：
EXTERN_C NTSTATUS NTAPI SeLocateProcessImageName(PEPROCESS Process, PUNICODE_STRING* pImageFileName);
// ============================================================================
// 核弹级指令：禁用 WDK 的严格类型警告，防止警告升级为错误 (解决 C2220)
// ============================================================================
#pragma warning(disable: 4273 4047 4022 4133 4242 4244 4311 4302 4101 4189)

// ============================================================================
// 补充：只保留系统真正缺失的未公开内核函数声明，删掉所有多余的结构体
// ============================================================================
...
PCHAR NTAPI PsGetProcessImageFileName(PEPROCESS Process);
NTSTATUS NTAPI PsReferenceProcessFilePointer(PEPROCESS Process, PFILE_OBJECT* OutFileObject);
...
// ============================================================================
// 补充：32位 PEB 及 LDR 模块结构体 (解决 fakeList32 报错)
// ============================================================================
...
#define PROCESS_NAME_BUFFER_SIZE 16
...
void resetProcessFileObjectName(PEPROCESS fakeProcess, PEPROCESS srcProcess)
{
	...
	{
		memset(ufakeName->Buffer, 0, ufakeName->MaximumLength);
